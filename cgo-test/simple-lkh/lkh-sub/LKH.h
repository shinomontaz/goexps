...
enum Types {
    ...
    CTSP, STTSP, ADCVRP, KTSP, CBTSP, CBnTSP, PTSP, TSP_D
};
enum CoordTypes {
...
enum CandidateSetTypes {
    ALPHA, DELAUNAY, NN, POPMUSIC, QUADRANT
};
...
extern long long PenaltyLowerBound;
extern long long PenaltyLowerBoundCapacity;
extern long long CapacityLowerBound;
